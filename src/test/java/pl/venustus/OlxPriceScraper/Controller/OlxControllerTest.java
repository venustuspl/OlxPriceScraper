...
class OlxControllerTest {
    ...
    private final OlxConnection olxConnection = Mockito.mock(OlxConnection.class);

    private final OlxService olxService = Mockito.mock(OlxService.class);

    private final String olxlink = "https://www.olx.pl";

    private final OlxController olxController = new OlxController(olxService);
    ...
    void shouldReceiveCorrectSumFromOlxStatisticObject() throws URISyntaxException, IOException {
        ...
        OlxStatistics olxStatistics = new OlxStatistics(olxlink, 5600.0, 2, 23000.0, 2300.0, 2300.0, 2300.0);
